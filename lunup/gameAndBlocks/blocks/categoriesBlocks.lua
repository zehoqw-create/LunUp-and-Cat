...
local function f(localityVariable, nameVariable, localityArray, nameArray, nameFunction, nameBackground, nameScene, nameSound, nameImage)
	local myTable = {
		...
		["sounds"]={
			...
			{"playSoundAndWait", {{"sounds",nameSound}}},
			{"stopSound", {{"sounds",nameSound}}},
			{"seekSound", {{"sounds",nameSound}, {{"number",1}}}},
			{"stopAllSounds"},
			{"setVolumeSound",{{{"number",60}}}},
			{"editVolumeSound", {{{"function","-"},{"number",10}}}},
		},
		...
		["particles"]={
			{"createParticle", {{{"text", app.words[417]}}, {"particle", "air_stars.json"}}},
			{"startStopParticle", {{{"text", app.words[417]}}, {"onOrOff", "on"}}},
			{"setPositionParticle", {{{"text",app.words[417]}},{{"number",100}},{{"number",200}}} },
			{"setRotateParticle",{{{"text",app.words[417]}},{{"number",10}}}},
			{"setSpeedParticle",{{{"text",app.words[417]}},{{"number",10}}}},
			{"setSizeParticle",{{{"text",app.words[417]}},{{"number",10}}}},
			{"deleteParticle", {{{"text",app.words[417]}}}},
			{"stopParticle", {{{"text",app.words[417]}}}},
			{"deleteAllParticles"},
			{"toFrontLayerParticle"},
			{"setLayerParticle", {{{"number", 2}}}},
			{"particleSceneInsertCamera", {{{"text",app.words[417]}}}},
			{"particleSceneRemoveCamera", {{{"text",app.words[417]}}}},
		},
		["donat"]={
			{"setTypeInputTextField", {{{"text", app.words[493]}}, {"inputType", "phone"}}},
			{"isSecureTextField", {{{"text", app.words[493]}}, {{"onOrOff", "on"}}}},
