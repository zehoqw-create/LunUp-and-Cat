...
calculateGameFormulas = {
    ["+"]="+",["-"]="-",["÷"]="/",["×"]="*",["("]="(",[")"]=")",
        ["<"]="<",[">"]=">",["≤"]="<=",["≥"]=">=",["="]=" == ",["≠"]="~=",
        [","]=",",["true"]="true",["false"]="false",["not"]="not",
        ["and"]="and",["or"]="or",sinus="lunupFuns.sin",cosine="lunupFuns.cos",
        tangent="lunupFuns.tan",naturalLogarithm="math.log",
        decimalLogarithm="math.log10",pi="math.pi",root="math.sqrt",
        random="math.random",absoluteValue="math.abs",round="math.round",
        modulo="math.fmod",arcsine="lunupFuns.asin",arccosine="lunupFuns.acos",
        arctangent="lunupFuns.atan", arctangent2="lunupFuns.atan2",exponent="math.exp",
        degree="math.pow",roundDown="math.floor",roundUp="lunupFuns.roundUp",
        maximum="math.max",minimum="math.min",ternaryExpression="lunupFuns.ternaryExpression"
        ,characterFromText="lunupFuns.characterFromText",length="plugins.utf8.len",
        connect="lunupFuns.connect",connect2="lunupFuns.connect",regularExpression="lunupFuns.regularExpression",
        layer="(0)",language=" '"..lang.."-"..string.upper(lang).."' ",
        lengthArray="#",elementArray="lunupFuns.getEllementArray",containsArray="lunupFuns.containsElementArray",
        indexArray="lunupFuns.getIndexElementArray",levelingArray="lunupFuns.levelingArray",
        displayPositionColor="lunupFuns.displayPositionColor",touchDisplayX="globalConstants.touchX",touchDisplayY="globalConstants.touchY",
        ...
        touchDisplayId="lunupFuns.getIsTouchId",countTouchDisplay="globalConstants.touchId",countTouch="lunupFuns.getCountTouch()",
