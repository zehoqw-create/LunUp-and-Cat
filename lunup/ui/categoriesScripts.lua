...
function scene_categoriesScripts(funAddBlock)
	...
	local categories = {{67,"used","orange"}, {68,"event","grown"},{69,"control","orange"},{70,"physic","blue"},{71,"sounds","violet"},{72,"images","green"},{427,"particles","olive"},{73,"pen","darkgreen"},{74,"data","red"},{75,"device","gold"},{532,"textFields","green"},{531,"miniScenes","yellow"}--[[,{587, "elementInterface", "pink"}]] ,{616,"donat","pink"}}
